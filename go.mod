...
// tailscale.com is pinned to the apenwarr/aperture patch rebased onto the
// post-v1.102 mainline (commit 71e90b2a2), which adds TS_FORCE_CACHE_NETMAP so clients can
